<?php namespace Rajv3\AdminTheme;
...
class AdminThemeServiceProvider extends AddonServiceProvider
{
    ...
    protected $middleware = [
        //Rajv3\AdminTheme\Http\Middleware\ExampleMiddleware::class
    ];
     ...
     */
    protected $listeners = [
        //Rajv3\AdminTheme\Event\ExampleEvent::class => [
        //    Rajv3\AdminTheme\Listener\ExampleListener::class,
        //],
     ...
     */
    protected $aliases = [
        //'Example' => Rajv3\AdminTheme\Example::class
    ];
