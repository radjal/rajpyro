...
//    import Status from '../models/Status';
	...
	import AddToStream from '../components/ContactForm.vue';
    ...
    export default {
        ...
        methods : {
               ...
               // } 		
				...
				onSubmit() {
					...
					this.form.message = document.querySelector('#message').value; 
					this.form._token = document.querySelector('[name=_token]').value; 
						...
						this.form
							...
							.then( response => {
										...
										if(response.success == true) {
											console.log('success');	
											//this.contact = '<h1>Sent</h1>';
											this.contact = '<div class="container has-text-centered">Sent<br/><span class="icon is-medium"><i class="fa fa-2x fa-check"></i></span></div>'
        ...
        mounted() {
			...
			return typeof(window.animSvg) !== 'function' ? false : window.animSvg() ;
					...
					this.form.action = document.querySelector('#contactform').action;
					this.form.name = document.querySelector('#name').value;
        } 
    }
